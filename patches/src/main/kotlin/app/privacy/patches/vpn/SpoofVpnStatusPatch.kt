...
private fun MethodReference.isNetworkCapabilitiesHasTransport() = definingClass == NETWORK_CAPABILITIES &&
    name == "hasTransport" &&
    parameterTypes.singleOrNull()?.toString() == "I" &&
    returnType == "Z"

private fun MethodReference.isNetworkCapabilitiesHasCapability() = definingClass == NETWORK_CAPABILITIES &&
    name == "hasCapability" &&
    parameterTypes.singleOrNull()?.toString() == "I" &&
    returnType == "Z"

private fun MethodReference.isNetworkCapabilitiesToString() = definingClass == NETWORK_CAPABILITIES &&
    name == "toString" &&
    parameterTypes.isEmpty() &&
    returnType == "Ljava/lang/String;"

private fun MethodReference.isNetworkRequestBuilderAddTransportType() = definingClass == NETWORK_REQUEST_BUILDER &&
    name == "addTransportType" &&
    parameterTypes.singleOrNull()?.toString() == "I" &&
    returnType == NETWORK_REQUEST_BUILDER

private fun MethodReference.isConnectivityManagerRegisterNetworkCallback() = definingClass == CONNECTIVITY_MANAGER &&
...
private fun MethodReference.isLinkPropertiesGetInterfaceName() = definingClass == LINK_PROPERTIES &&
    name == "getInterfaceName" &&
    parameterTypes.isEmpty() &&
    returnType == "Ljava/lang/String;"

private fun MethodReference.isLinkPropertiesGetHttpProxy() = definingClass == LINK_PROPERTIES &&
    name == "getHttpProxy" &&
    parameterTypes.isEmpty() &&
    returnType == "Landroid/net/ProxyInfo;"

private fun MethodReference.isLinkPropertiesGetRoutes() = definingClass == LINK_PROPERTIES &&
    name == "getRoutes" &&
    parameterTypes.isEmpty() &&
    returnType == "Ljava/util/List;"

private fun MethodReference.isNetworkInterfaceGetNetworkInterfaces() = definingClass == NETWORK_INTERFACE &&
...
private fun List<Instruction>.hasVpnTransportLiteralBefore(index: Int, register: Int) = hasLiteralBefore(index, register, TRANSPORT_VPN)

private fun List<Instruction>.hasNotVpnCapabilityLiteralBefore(index: Int, register: Int) = hasLiteralBefore(index, register, NET_CAPABILITY_NOT_VPN)

private fun List<Instruction>.hasVpnDetectionString(): Boolean = any { instruction ->
...
private fun List<Instruction>.hasVpnOsStatePatchTarget(): Boolean = withIndex().any { (index, instruction) ->
...
private fun List<Instruction>.hasVpnNetworkRequestBuilder(): Boolean = withIndex().any { (index, instruction) ->
    val reference = instruction.methodReferenceOrNull() ?: return@any false
    val transportRegister = instruction.registers().lastOrNull() ?: return@any false
